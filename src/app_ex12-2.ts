...
//
        ...
        let update: FrameRequestCallback = (time) => {
            ...
            //車を動かす
            vehicle.setWheelForce(x, 1);
            vehicle.setWheelForce(x, 0);

            vehicle.setSteeringValue(THREE.MathUtils.degToRad(z), 0);
            vehicle.setSteeringValue(THREE.MathUtils.degToRad(z), 1);
