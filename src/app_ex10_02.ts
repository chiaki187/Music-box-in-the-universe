...
class ThreeJSContainer {
    ...
    private createScene = () => {
        ...
        points2.push(points2[10]);
        points2.push(points2[11]);

        points2.push(new THREE.Vector3(-4, 2, 0));
        points2.push(new THREE.Vector3(-4, -2, 2));
        ...
        let update: FrameRequestCallback = (time) => {
            ...
            //const pos = lerp(points[seg*4+0], points[seg*4+1],points[seg*4+2],points[seg*4+3], t);
             ...
             const pos = hermite(points2[seg*4+0], points2[seg*4+1],points2[seg*4+2],points2[seg*4+3], t);
             obj.position.copy(pos);
            obj.lookAt(new THREE.Vector3(obj.position.x, obj.position.y, 0));
