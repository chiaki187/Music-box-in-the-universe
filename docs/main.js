...
function init() {
    ...
    let viewport = container.createRendererDOM(window.innerWidth, window.innerHeight, new three__WEBPACK_IMPORTED_MODULE_2__.Vector3(20, 20, 5)); //カメラの座標
