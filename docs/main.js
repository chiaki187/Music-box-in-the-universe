...
function init() {
    ...
    let viewport = container.createRendererDOM(window.innerWidth, window.innerHeight, new three__WEBPACK_IMPORTED_MODULE_2__.Vector3(10, 10, 10)); //カメラの座標
